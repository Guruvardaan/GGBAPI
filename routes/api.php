...
Route::get('download-excel-gstr1-detail', [ExcelController::class, 'download_excel_gstr1_detail']);
Route::get('download-excel-gstr2-detail', [ExcelController::class, 'download_excel_gstr2_detail']);
